 ...
 *
 * This interface is tied to CRUD6's Sprunje API, accessed at the
 * GET `/api/crud6/groups` endpoint and the `GroupsSprunjerResponse` Typescript
 * interface.
 *
...
export function useGroupsApi() {
    ...
    async function updateGroups() {
        ...
        await axios
            .get<GroupsSprunjerResponse>('/api/crud6/groups')
            .then((response) => {
