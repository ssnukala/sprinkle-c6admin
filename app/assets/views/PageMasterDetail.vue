...
import { useCRUD6Api, useCRUD6Schema, useMasterDetail } from '../composables'
import type { DetailRecord, DetailEditableConfig } from '../composables'
import type { CRUD6Response, CRUD6Interface } from '../interfaces/types'
