...
/*
 * UserFrosting C6Admin Sprinkle Integration Test - Seed Validation Script
 *
 * This script validates that CRUD6 seeds (required by C6Admin) have been run successfully.
...
echo "=========================================\n";
echo "Validating C6Admin Dependencies (CRUD6 Seed Data)\n";
echo "=========================================\n\n";
...
echo "\n=========================================\n";
echo "✅ All C6Admin dependencies (CRUD6 seed data) validated successfully\n";
echo "=========================================\n";
